...
```text
ProjectOps schema subset: 14/14 PASS; 5 schemas and 253 controlled instances
ProjectOps validation: 108/108 PASS
ProjectOps reconcile tests: 5/5 PASS
Tool contract harnesses: 613/613 PASS
Full repository suite: 740/740 PASS
Repository source baseline: 136 events, 114 messages, 25 agents; the 2026-08-13 F01/F02 AI Provider-policy authorization contract is the latest registered artifact. It proves strict local policy profiles, evidence/risk/validity/region semantics, exact request subjects, Apple-prohibited-use blocking, and subject/profile/D-053 fingerprints. Even an exact local ALLOW profile remains blocked because D-053 is CANDIDATE/NOT_AUTHORIZED; the harness performs zero key reads, sensitive-body serialization, network requests, or business writes. Earlier F18 wipe, F19 restore/import, F03 data-pack/lookup, F09, F16, F18 access, prohibited-capability, and platform/language contracts retain their recorded boundaries.
...
External workbench live/static smoke: NOT RUN; the prior 129-event/93-document result is historical and no longer proves parity with the 136-event repository source
...
workbench was not present for the AI policy verification, so no current static copy
