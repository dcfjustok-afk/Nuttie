...
Current merged workbench parity: NOT RUN for the 180-event source; the historical 142-event PASS cannot prove current live/static equality.
...
has not been rerun against the current 180-event repository source.
