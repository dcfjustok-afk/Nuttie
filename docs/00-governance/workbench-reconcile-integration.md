...
Current merged workbench parity: NOT RUN for the 183-event source; the historical 142-event PASS cannot prove current live/static equality.
...
has not been rerun against the current 183-event repository source.
