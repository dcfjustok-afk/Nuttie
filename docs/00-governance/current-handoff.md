...
2. **D-040 已完成问题分解，前三批选择卡仍待独立评审。** A/B/C 流程、恢复、无目标和失败零写入已形成原型；公式/治理证据复审归零，20 个决定轴已分配候选 ID，十三张卡完成自审。中国宏量现行标准证据已补齐；中国支持/健康治理输入草案也已形成。NIDDK 动态模型来源可行性已核验，但许可、稳定版本、官方 oracle corpus、回归容差、保护线和具名健康评审仍未关闭；不得把当前网页 hash、固定测试夹具、作者草案或参考带当作已批准产品规则，也不得直接向 Owner 提交未成熟选择卡。
