...
| 字段 | 当前事实 |
| --- | --- |
| 快照日期 | 2026-08-20（Asia/Shanghai）；ProjectOps 人工归并快照与 2026-08-20 最新事件源一致 |
...
2. **D-040 已完成问题分解，前三批选择卡仍待独立评审。** A/B/C 流程、恢复、无目标和失败零写入已形成原型；公式/治理证据复审归零，20 个决定轴已分配候选 ID，前三批十三张卡和 D-063 来源卡完成内部自审。D-063 仍缺 D-068/D-069、具名健康批准、Content QA 和独立复核。中国宏量现行标准证据与健康评审交接包已补齐，但交接包就绪不等于具名评审人已指派、资质已核验或健康/Content QA 已批准。NIDDK 动态模型来源可行性已核验，但许可、稳定版本、官方 oracle corpus、回归容差、保护线和具名健康评审仍未关闭；不得把当前网页 hash、固定测试夹具、作者草案、内部自审或参考带当作已批准产品规则，也不得直接向 Owner 提交未成熟选择卡。
...
恢复后至少重新确认：决定是 29/3；事件/消息/角色是 178/116/25 且仅 `root` 活跃；D-039=A 为 `ACCEPTED / PX-4_BASELINE_FROZEN / PX-5_DOR_NOT_READY`，B01/B02 已关闭、B03~B07 共 5 项开放且正式实现为 false；D-045、D-031、D-033、D-034、D-036 与 D-053 三包内部卡自审通过但独立复核/Owner 卡未排期；D-053 仍是台账内 candidate，其余内部卡未进入决定台账或 Owner intake；D-034 还需最低支持 iPhone benchmark，D-036 还需 OI-07、三 Provider 兼容 Spike和原生边界证据，D-053 还需 OI-07、逐 Provider 十维证据与 App Privacy 映射；D-040 为 `CANDIDATE / PX-0_INPUT_GAP / CHINA_HEALTH_REVIEWER_ASSIGNMENT_AND_INDEPENDENT_REVIEW_REQUIRED`，前三批十三卡完成自审且独立复核包就绪，但具名复核人、身份/独立性核验和实际复核未完成；健康评审九工件/十三项交接包已就绪，但具名健康评审人、资质、正式评审、批准与 Content QA 未完成，两份包均未外联。WS/T 578.1-2017 现行宏量证据已补齐但 D-063 未 Owner-ready；NIDDK 动态模型来源可行性已核验但采用证据未通过，D-062/D-059 对应项未 Owner-ready，D-054~D-072 仍仅预留。D-032 是 `CANDIDATE + SPIKE_AUTHORIZED` 且 Windows JS/类型依赖表面、Android/iOS 平台条件 export 与共用结构校验子范围已通过。OI-02 精确为 Bundle ID 尚未创建、SKU=`N/A`，OI-03 精确为 iPhone 16 Pro Max / iOS 26.5 / 无 Mac；D-052/D-053 继续 fail closed；根目录正式工程、原生、签名、Archive 与 TestFlight 仍未授权。
