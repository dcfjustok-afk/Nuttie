...
[首个 MVP 增量跨角色复核包](../02-product/mvp-increment-scope-review-packet.md)也已准备，固定 11 份输入、3 个范围选项、5 个复核域、12 条跨选项不变量和 P0~P3 标准。当前仅为 `PACKET_READY / REVIEWERS_UNASSIGNED / REVIEW_NOT_STARTED / NOT_PASSED`；它不构成 Owner 选择、范围冻结、G2 PASS、正式工程、原生或实现授权。
