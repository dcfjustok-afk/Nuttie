...
`project-ops/snapshots/current.json` 已于 `2026-08-13T19:26:22+08:00` 完成人工归并，当前记录 17 项 accepted、14 项 candidate、127 个事件、114 条 Agent 消息、25 个角色和 1 个活跃角色；唯一活跃角色是 PM `root`。最新事件登记 F18 唯一版本化领域注册表、generation/registry 绑定和跨领域一致性只读事务端口合同；它没有选择 D-020、没有实现 SQLCipher snapshot transaction，也没有改变 Owner intake 或 Gate。此前 AI 凭据、F04/F05/F06/F08/F10/F11/F12/F13/F14/F15/F17/F18/F21、F20/F23/F24 禁止能力和 F22 平台/语言 Release 合同仍保持原边界。两项 Release 聚合审计当前都明确为 `BLOCKED`：没有正式签名 Release Archive，F20/F23/F24 缺 27 面生产报告；F22 还缺设备族、方向、Mac、Vision availability 四项权威决定和 25 面发布报告。OI-03 已通过原生 choice-ui 记录为当前只有 `iPhone 16 Pro Max / iOS 26.5`、暂无可用 Mac；两路独立审查确认这不授权 iOS 原生工作。D-039 仍保持 PX-2，D-040 仍阻断于 PX-0。
