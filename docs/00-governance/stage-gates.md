...
| G2 | 产品基线 | IN_PROGRESS | F01-F24、REQ-F01-F24、AT-F01-F24 集合完整；五项追踪整改最终复验通过；首批 Owner 输入已确认；首个 MVP 增量与后续范围边界三选一卡及跨角色复核包已准备，11 项输入清单已冻结到同一提交的原始 Git blob 与规范 SHA-256，仍待具名复核人指派、实际复核、Owner 选择与正式冻结 |
