...
3. D-045、D-031 与 B05 的 D-033/D-034/D-036/D-053 内部卡均已完成四域自审，当前必须先通过独立复核才可展示；D-034 benchmark 协议已准备但仍缺最低设备/工具链/harness/fixture/实测，OI-07 统一输入模板已准备但 Owner 输入/Provider target 均未取得，D-036 Provider/原生兼容协议已准备，但仍需 OI-07、Provider 目标、Mac/Xcode、原生 harness、合成 corpus、凭证注入、真实网络授权、执行/结果和独立复核，D-053 Provider 证据/App Privacy 协议已准备，但仍需 OI-07、Provider、证据采集/快照、映射、具名签署和独立复核。
