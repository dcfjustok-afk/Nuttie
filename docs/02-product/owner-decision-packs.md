...
| --- | --- | --- | --- | --- |
| D-039 | 添加餐食首层方式 | A 本地搜索/最近优先，扫描和 AI 并列；B 记住上次；C 全方式平铺 | `A / ACCEPTED / PX-4_BASELINE_FROZEN` | PX-5 B01 验收矩阵与 B02 路由契约已关闭；B03~B07 共 5 项待关闭 |
| D-040 | 首启资料与目标 | A 最小资料 + 可解释公式候选 + 用户确认；B 只手工；C 强制完整问卷 | 未到选择阶段 | 20 个独立决定轴已分配 ID；前三批十三卡复核包和健康交接包就绪；D-063 来源卡与 D-070 输入形态卡内部成稿，但前置接受、健康数值边界、具名复核和采用证据仍未关闭 |
...
OI-02 已确认 Bundle ID 尚未创建，具体值为空，App ID 与 App Store Connect record 均未创建，SKU=`N/A`；具体 Bundle ID 最迟在首次自用真机签名配置前另行确认。OI-03 已确认当前只有 `iPhone 16 Pro Max / iOS 26.5`、暂无可用 Mac。D-039 已由 Owner 选择 A 并完成 PX-4；D-040 仍只是计划中的宿主原生队列占位，前三批十三张内部卡片已完成四域自审，十三卡独立复核包、中国健康评审九工件/十三项交接包和 WS/T 578.1-2017 宏量现行证据已形成，当前处于 `PX-0_INPUT_GAP / CHINA_HEALTH_REVIEWER_ASSIGNMENT_AND_INDEPENDENT_REVIEW_REQUIRED`。D-063 已形成三项互斥来源卡，D-070 已形成完整克数、固定 100% 三项比例、显式缺项克数三项互斥输入形态卡并完成内部自审；但 D-063 尚未接受，D-068/D-069、健康数值边界、Content QA 和独立复核未完成。两份包只代表材料可交接；卡片复核人和健康评审人都未具名，身份/资质/独立性/利益冲突未核验，实际复核、批准和 Content QA 未发生，也未发送外部消息。NIDDK 动态模型的论文、方程和七个当前网页代码资产已完成来源可行性核验，但逐文件许可、稳定版本、官方 oracle corpus、回归容差、保护线、具名健康评审和独立复核未完成；D-063、D-070 及 D-062/D-059 动态模型项仍未 Owner-ready，不得提前展示。
