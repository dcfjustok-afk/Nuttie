...
| --- | --- | --- | --- | --- |
| D-039 | 添加餐食首层方式 | A 本地搜索/最近优先，扫描和 AI 并列；B 记住上次；C 全方式平铺 | `A / ACCEPTED / PX-4_BASELINE_FROZEN` | PX-5 B01/B02 已关闭；B03~B05 六卡统一复核包已准备但输入未冻结、复核未开始；B03~B07 共 5 项待关闭 |
