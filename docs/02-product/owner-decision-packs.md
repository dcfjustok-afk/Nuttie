...
| D-040 | 首启资料与目标 | A 最小资料 + 可解释公式候选 + 用户确认；B 只手工；C 强制完整问卷 | 未到选择阶段 | 20 个独立决定轴已分配 ID；前三批十三卡独立复核包和中国健康评审九工件/十三项交接包均就绪，但两类具名复核人、身份/资质/独立性核验和实际复核均未完成；WS/T 578.1-2017 证据已补齐，NIDDK 采用证据未通过 |
