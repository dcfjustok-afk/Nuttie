...
| [d040-non-diagnostic-boundary-card-spec.md](d040-non-diagnostic-boundary-card-spec.md) | D-068/D-069 慢病/用药非诊断输入与估算不确定性表达卡；[17 项本地 validator](../04-engineering/testing/d040-non-diagnostic-boundary-card-harness.md)已固定 fail-closed、无副作用与 Owner/PX/实现全关闭边界，但健康批准、Content QA 和独立复核未通过 |
| [d040-non-diagnostic-boundary-independent-review-packet.md](d040-non-diagnostic-boundary-independent-review-packet.md) | D-068/D-069 非诊断边界独立复核包；固定 8 份必读输入、4 个复核域、2 卡处置、10 条跨卡不变量与 P0~P3，复核人未指派且复核未开始 |
| [D-040 D-068/D-069 非诊断边界独立复核回执合同](../04-engineering/testing/d040-non-diagnostic-boundary-independent-review-record-contract.md) / [20 项本地 validator](../04-engineering/testing/d040-non-diagnostic-boundary-independent-review-record-harness.md) | 固定同一 frozen packet、8 输入、四域 attestation、2 卡、10 条跨卡不变量、P0~P3、disposition 与双 SHA-256；合成 fixture 非正式证据，真实回执、复核人核验、健康批准、Content QA、Owner/PX 与实现仍为 0/false |
| [D-040 D-068/D-069 非诊断边界复核人接入包](d040-non-diagnostic-boundary-reviewer-intake-packet.md) | 明确 4 域复核候选字段、受控联系人/敏感信息存储边界、未发送请求模板与正式回执交接规则；真实候选人、联系人、联络授权、正式指派、复核、健康批准、Content QA、Owner/PX 与实现仍为 0/false |
| [D-040 D-068/D-069 非诊断边界正式复核交接清单](d040-non-diagnostic-boundary-review-handoff-checklist.md) | 固定从接入包到正式复核回执前的 6 个前置物、8 项启动条件、8 类失败关闭情况和 8 类禁止入库敏感信息；`reviewCanStart=false`，真实候选人、联系人、联络授权、正式指派、正式回执、健康批准、Content QA、Owner/PX 与实现仍为 0/false |
| [D-040 D-068/D-069 非诊断边界复核启动缺口登记表](d040-non-diagnostic-boundary-review-start-gap-register.md) | 固定 handoff checklist 之后仍开放的 10 个启动阻断项；`openGapCount=10 / closedGapCount=0 / reviewCanStart=false`，关闭任一缺口都必须另有授权记录 |
| [D-040 D-068/D-069 非诊断边界复核人指派合同](../04-engineering/testing/d040-non-diagnostic-boundary-reviewer-assignment-contract.md) / [21 项本地 validator](../04-engineering/testing/d040-non-diagnostic-boundary-reviewer-assignment-harness.md) | 固定同一 frozen packet、四域逐域胜任、候选身份/起草/冲突/覆盖、联络授权/时序/签署、assignment SHA-256 与敏感信息边界；真实候选人、联系人、授权、正式指派、复核、健康批准、Content QA、Owner/PX 与实现仍为 0/false |
| [D-040 D-068/D-069 非诊断边界指派授权预检清单](d040-non-diagnostic-boundary-assignment-authorization-preflight-checklist.md) | 固定未来联络、材料发送和正式指派前的 8 项缺失授权输入、9 个范围绑定与 8 项启动门槛；`AUTHORIZATION_NOT_GRANTED`，真实候选人、联系人、授权、材料发送、正式指派、复核、健康批准、Content QA、Owner/PX 与实现仍为 0/false |
| [D-040 D-068/D-069 非诊断边界联络授权记录合同](../04-engineering/testing/d040-non-diagnostic-boundary-contact-authorization-record-contract.md) | 固定未来非敏感授权记录的 12 个字段、10 个 prior event 绑定、8 类禁止存储敏感信息和 8 条验收/过期规则；`authorizationRecordCount=0`，不推断联络授权、材料发送、复核、Owner/PX 或实现 |
| [D-040 D-068/D-069 非诊断边界候选名单记录合同](../04-engineering/testing/d040-non-diagnostic-boundary-reviewer-candidate-roster-contract.md) | 固定未来非敏感 reviewer candidate roster 的 14 个字段、11 个 prior event 绑定、9 类禁止存储敏感信息和 9 条验收/过期规则；`reviewerCandidateRosterCount=0`，不推断真实候选人、联系人授权、材料发送、正式指派、复核、Owner/PX 或实现 |
...
| [D-040 前三批十三卡复核人接入与指派检查包](d040-first-three-batches-reviewer-intake-packet.md) | 复用同一 frozen packet，固定四域逐域胜任、身份/起草/冲突/覆盖、受控联系人、联络授权、时间与签署接入字段；当前真实候选人、联系人、授权、指派、复核和 PASS 均为 0/false |
