...
| [D-039 B03~B05 六卡独立复核包](d039-b03-b05-independent-review-packet.md) | 10 份输入、6 卡逐项处置、3 个阻断项、4 个复核域、16 条跨卡不变量与 P0~P3 标准；10 项输入已冻结并记录 blob OID/SHA-256；当前待指派具名复核人 |
