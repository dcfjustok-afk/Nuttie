...
macroAxisRequiredCrossAxisInvariantCount: 14
macroAxisIndependentReviewersAssigned: false
macroAxisReviewerIndependenceVerified: false
macroAxisIndependentReviewStarted: false
