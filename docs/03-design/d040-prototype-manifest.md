...
| 状态 | `CANDIDATE / PX-0_INPUT_GAP / DECISION_CARD_SPEC_REVIEW_REQUIRED` |
...
- 该原型于 2026-08-06 登记时，OI-03 是 Owner intake 的下一张卡，D-040 不得抢占或改写该历史顺序。OI-03、OI-02、首批整批回读和 D-039 PX-3/PX-4 后续均已完成；计划中的宿主原生队列占位现为 D-040，但在 `PX-0_INPUT_GAP / DECISION_CARD_SPEC_REVIEW_REQUIRED` 关闭前仍不得提交 Owner。
