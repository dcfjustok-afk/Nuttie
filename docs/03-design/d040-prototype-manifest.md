...
| 状态 | `CANDIDATE / PX-0_INPUT_GAP / FORMULA_REVIEW_REQUIRED` |
...
- 该原型于 2026-08-06 登记时，OI-03 是 Owner intake 的下一张卡，D-040 不得抢占或改写该顺序。OI-03 后续已完成，当前下一张原生 choice-ui 是 OI-02；D-040 仍不得抢占，D-039 的 PX-3 也仍未完成。
